...
from app.product.product_routers import insert_data_to_product
...
def import_overview(entity = None):
    ...
    return render_template('import_index.html',
                            ...
                            entity = entity,                          
                            first_duplicate_rows = first_duplicate_rows,    # check only XLSX
                            repeated_rows = repeated_duplicate_rows,        # check only XLSX
...
def perform_and_insertdata(entity):
    ...
    if entity == "product":
        ...
        success, error = insert_data_to_product(temp_ExcelData)
        if success:
